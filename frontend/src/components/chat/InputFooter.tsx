/**
 * InputFooter — chat input bar with auto-expanding textarea and send button.
 * Extracted into a reusable component so the page layout can place it
 * independently of the message list. Voice input is handled via FloatingVoiceButton.
 */
