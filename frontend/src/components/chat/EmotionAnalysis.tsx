/**
 * EmotionAnalysis — right-panel widget showing emotion distribution from recent
 * messages. Displays dominant emotion, confidence score, and a history bar chart.
 */
