 ...
 *  - Voice input (STT) via FloatingVoiceButton + per-message TTS
 *  - Language preference selector (English / Tamil / Bilingual)
 *  - Contextual breathing exercise prompt on anxiety/high-risk
 *  - Mobile-responsive layout with slide-out insights drawer
 *  - Robust API response normalization (reply|response|message|bot_response|response_text)
 *  - Guardian-alert / onboarding compatible
 */
...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-950">
      ...
      {/* Main content area — 70/30 split layout */}
